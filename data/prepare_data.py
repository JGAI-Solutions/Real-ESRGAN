...
def parse_arguments():
    ...
    parser.add_argument('--crop_size_min', type=int, default=512, help='Minimum crop size')
    parser.add_argument('--lq_size', type=int, default=128, help='LQ output resolution dimension')
    parser.add_argument('--gt_size', type=int, default=512, help='GT output resolution dimension')
